...
def show_user_guide():
    ...
    text.setText(
        ...
        "- Footpaths\n\n"
        "Instructions:\n"
        "1. Click 'Image' to upload an image.\n"
        "2. Click 'Video' to upload a video.\n"
        "3. Uploaded files are saved in 'uploads' folder.\n"
        "4. Detection results are saved in 'results' folder.\n"
        "5. Click 'View Uploads', 'View Results', or 'View Report' to open folders.\n"
        "6. Click 'Clear Uploads' or 'Clear Results' to delete files.\n"
        "7. Supported formats: *.jpg, *.png, *.jpeg, *.mp4, *.avi, *.mov.\n"
    )
...
window = QWidget()
window.setWindowTitle("🚦 RoadSight Upload System")
...
subtitle = QLabel(
    ...
    "RoadSight can detect traffic signs, poles, lighting, trees, lanes, bike lanes, barriers, footpaths."
)
